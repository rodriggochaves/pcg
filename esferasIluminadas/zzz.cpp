...
int main( void )
{
  ...
  window =  glfwCreateWindow( 600, 600, "Esfera", NULL, NULL);
  ...
  GLuint sp4;//nomes dos Shaders Programs
  sp4 = myInit_IlumTexture(window, "t4.vert", "bpt.frag" );
